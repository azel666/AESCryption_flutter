...
class AdminDecryptCard extends StatefulWidget {
  final listAllDocument;
  const AdminDecryptCard({required this.listAllDocument, super.key});

  @override
  State<AdminDecryptCard> createState() => _AdminDecryptCardState();
}

class _AdminDecryptCardState extends State<AdminDecryptCard> {
  @override
