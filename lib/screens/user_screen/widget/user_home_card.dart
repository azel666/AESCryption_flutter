...
import 'package:sistem_kriptografi/screens/user_screen/user_home_detail.dart';

class UserHomeCard extends StatefulWidget {
  final listAllDocument;
  const UserHomeCard({required this.listAllDocument, super.key});

  @override
  State<UserHomeCard> createState() => _UserHomeCardState();
}
          ...
          children: [
            InkWell(
              onTap: () {
                ...
                Get.to(UserHomeDetail(detail: detail));
              },
              child: Container(
